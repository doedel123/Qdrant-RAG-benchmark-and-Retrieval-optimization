...
befuellt). Query Expansion und Reranking folgen der Provider-Auswahl in
``retrieve.JuristischerRetriever``; default ist lokal (Ollama + Cross-Encoder).
...
class OursMxbaiRetriever:
    """
    Unsere lokale Pipeline: mxbai-de-Embeddings, Query Expansion, Hybrid Search
    und Reranking gegen die konfigurierte Qdrant-Collection.
    """
